...
class AnnouncementForm(TranslatableModelForm):
	...
	class Meta:model=Announcement;fields=[_D,_F,_G,_H,_M,_B]
	def __init__(self,*args,**kwargs):
		...
		self.helper=FormHelper();self.helper.form_method=_C;self.helper.layout=Layout(Row(Column(_D,css_class=_A),Column(_F,css_class=_A),Column(_G,css_class=_A),Column(_M,css_class=_A),Column(_H,css_class=_A),Column(_B,css_class=_A)))
...
class ArticleForm(TranslatableModelForm):
	dim_w=forms.CharField(widget=forms.HiddenInput(),initial=870);dim_h=forms.CharField(widget=forms.HiddenInput(),initial=500)
	class Meta:model=Article;fields=[_D,_F,_G,_H,_J,_B]
	def __init__(self,*args,**kwargs):
		site_id=kwargs.pop(_N);super().__init__(*(args),**kwargs)
		if site_id:self.fields[_H].queryset=Tags.objects.filter(site_id=site_id);self.fields[_G].queryset=Categories.objects.filter(site_id=site_id)
		self.helper=FormHelper();self.helper.form_method=_C;self.helper.layout=Layout(Row(Column(_D,css_class=_A),Column(_F,css_class=_A),Column(_G,css_class=_A),Column(_H,css_class=_A),Column(_B,css_class=_A)))
...
class HowItWorksForm(TranslatableModelForm):
	class Meta:model=HowItWorks;fields=[_D,_F,_K,_L,_J,_B]
	def __init__(self,*args,**kwargs):super().__init__(*(args),**kwargs);self.helper=FormHelper();self.helper.form_method=_C;self.helper.layout=Layout(Row(Column(_D,css_class=_A),Column(_F,css_class=_A),Column(_K,css_class=_A),Column(_L,css_class=_A),Column(_J,css_class=_A),Column(_B,css_class=_A)))
class PhotoGalleryForm(TranslatableModelForm):
	...
	class Meta:model=PhotoGallery;fields=[_D,_F,_L,_J,_B]
	def __init__(self,*args,**kwargs):super().__init__(*(args),**kwargs);self.helper=FormHelper();self.helper.form_method=_C;self.helper.layout=Layout(Row(Column(_D,css_class=_A),Column(_F,css_class=_A),Column(_B,css_class=_A)))
...
class MenuForm(TranslatableModelForm):
	class Meta:model=Menu;fields=[_E,_I,_W,_K,_X,_Y]
	def __init__(self,*args,**kwargs):super().__init__(*(args),**kwargs);self.helper=FormHelper();self.helper.form_method=_C;self.helper.layout=Layout(Row(Column(_E,css_class=_A),Column(_I,css_class=_A),Column(_W,css_class=_A),Column(_K,css_class=_A),Column(_X,css_class=_A),Column(_Y,css_class=_A)))
...
class ProductForm(TranslatableModelForm):
	dim_w=forms.CharField(widget=forms.HiddenInput(),initial=870);dim_h=forms.CharField(widget=forms.HiddenInput(),initial=500)
	class Meta:model=Product;fields=[_E,_D,_F,_L,_J,_B]
