...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('education', '0024_photogallerytranslation_content'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('master', parler.fields.TranslationsForeignKey(editable=False, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='translations', to='education.offers')),
            ],
            options={
                'verbose_name': 'offers Translation',
                'db_table': 'education_offers_translation',
                'db_tablespace': '',
                'managed': True,
                'default_permissions': (),
